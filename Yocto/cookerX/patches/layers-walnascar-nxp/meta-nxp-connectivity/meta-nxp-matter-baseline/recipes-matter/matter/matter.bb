...
SRCBRANCH = "v1.4.1-branch-nxp_imx_2025_q2"
...
SRC_URI += "file://0002-chip_tool_web-Add-paa-trust-store-path.patch"
MATTER_PY_PATH ?= "${STAGING_BINDIR_NATIVE}/python3-native/python3"

#PATCHTOOL = "git"
#skip git apply / git commit
#PATCHTOOL = "patch"
#PATCH_COMMIT_FUNCTIONS = ""
#PATCH_FLAGS = "-N --no-backup-if-mismatch"
